...
export type State = TodosState & VisibilityFilterState & LayoutState & LocaleState;

export type Action = ReduxInitAction | TodosAction | VisibilityFilterAction | LayoutAction | LocaleAction;
